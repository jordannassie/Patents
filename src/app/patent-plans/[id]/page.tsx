    ...
    <div className="min-h-screen bg-black">
      <div className="mx-auto max-w-5xl px-4 py-12 sm:px-6 lg:px-8">
        ...
        <div className="mb-6 rounded-xl border border-zinc-800 bg-zinc-900/50 p-6">
          ...
          {(() => {
            const classification = classifyPatentStatus(plan.source_status_estimate);
            return (
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div className="text-xs text-zinc-500 mt-1">
                    Raw estimate: {plan.source_status_estimate}
                  </div>
                </div>
        ...
        <div className="mb-6 rounded-xl border-2 border-indigo-800 bg-indigo-950/30 p-6">
