                  ...
                  <div className="text-xs mt-2">
                    {hunterStatus.pendingTasks > 0 && !hunterStatus.cronDetected ? (
                      <div className="text-yellow-400 flex items-center gap-1">
                        ...
                        <span>Automation not connected yet. Scheduled functions or external cron must call the worker endpoint every 10 minutes.</span>
                      </div>
                      ...
                      <div className="text-yellow-400 flex items-center gap-1">
                        ...
                        <span>Automation delayed — no cron check in the last 15 minutes</span>
                      </div>
                    ) : (
